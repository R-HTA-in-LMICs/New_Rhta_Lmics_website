...
Our LMIC chapter delivers: - **Introductory workshops**: Covering R basics and essential HTA packages - **Advanced tutorials**: Building cost-effectiveness models and interactive apps using [Shiny](https://shiny.rstudio.com/) - **Free resources and code**: All available on our [GitHub](https://github.com/) page
